...
namespace ACE.Network.GameEvent.Events
{
    ...
    {
        public GameEventChannelBroadcast(Session session, ChannelChatType chatChannel, string senderName, string messageText) : base(GameEventType.ChannelBroadcast, GameMessageGroup.Group09, session)
        {
