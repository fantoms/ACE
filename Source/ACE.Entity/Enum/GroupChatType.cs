...
{
    /// <summary>
    /// The ChannelChatType identifies the type of group chat message.<para />
    /// Used with F7B0 0147: Game Event -> Group Chat (ChatChannel)
    /// </summary>
    [Flags]
    ...
    {
        /// <summary>
        /// Undefined Value, a non-existing, non-working channel to check against and use as a default value
        /// </summary>
        Undef               = 0x00000000,
        ...
        /// <summary>
        /// Scociety Chat - Celetial Hand Faction
        /// </summary>
        CelestialHand       = 0x08000000,

        /// <summary>
        /// Scociety Chat - Eldrytch Web Faction
        /// </summary>
        EldrytchWeb         = 0x10000000,

        /// <summary>
        /// Scociety Chat - Radiant Blood Faction
        /// </summary>
        RadiantBlood        = 0x20000000,

        /// <summary>
        /// Scociety Chat - Olthoi Faction
        /// </summary>
        Olthoi              = 0x40000000,
    }
}
